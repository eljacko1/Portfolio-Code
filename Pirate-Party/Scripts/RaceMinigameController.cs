...
public class RaceMinigameController : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject barrelSpawn1;
    [SerializeField]
    private GameObject barrelSpawn2;
    [SerializeField]
    ...
    private IEnumerator Countdown()
    {
        ...
        barrelSpawn1.SetActive(true);
        barrelSpawn2.SetActive(true);
        foreach (PlayerController controller in playerControllers)
        {
    ...
    private IEnumerator FinishMinigame()
    {
        ...
        if(barrelSpawn1 != null)
        {
            barrelSpawn1.SetActive(false);
        }
        if (barrelSpawn2 != null)
        {
            barrelSpawn2.SetActive(false);
        }
        ...
        if (winner == 1)
        {
            ...
            player1.transform.position = spawnPoints[2].transform.position;
            player2.SetActive(true);
            player2.transform.position = spawnPoints[3].transform.position;
